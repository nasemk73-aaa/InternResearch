...
> **Note:**  
> This document is mainly for agents and LLMs to follow when applying styles,  
> creating UI, or working with design tokens in the embedded-components repository. Humans  
...
Tailwind CSS styling patterns with mandatory `eb-` prefix for embedded components. This skill provides comprehensive guidance on using Tailwind CSS classes, responsive design, design tokens, and accessibility patterns.

...
2. **Run test suite**: `cd embedded-components; yarn test`
3. **Analyze failures** by type (TypeScript, formatting, linting, tests)
4. **Prioritize fixes** (TypeScript → Formatting → Linting → Tests)
5. **Fix issues systematically**
6. **Verify all fixes** by re-running tests
